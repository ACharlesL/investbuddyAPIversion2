...
1.  Rename the directory from investBuddy version 2 API -> your-app-name.
1.  Empty [`README.md`](README.md) and fill with your own content.
1.  Move into the new project and `git init`.
1.  Replace all instances of `'express-api-template'` with your app name.
1.  Install dependencies with `npm install`.
1.  Ensure that younpm have `nodemon` installed by running `npm install -g nodemon`.
